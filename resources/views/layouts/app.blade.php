        ...
        <div class="collapse navbar-collapse d-flex justify-content-between" id="navbarNav">
            ...
            <ul class="navbar-nav">
                @auth
                    <li class="nav-item">
                        <a data-bs-toggle="modal" data-bs-target="#exampleModal"
                            class="nav-link text-white font-weight-bold p-3" href="{{ route('dashboard') }}"><i
                                class="fa fa-twitter fs-4 text-primary"></i></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="dropdown-toggle nav-link text-white font-weight-bold p-3 pe-5 text-uppercase"
                ...
                @guest
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white font-weight-bold p-3 pe-5" href="{{ route('register') }}">Register</a>
                    </li>
                @endguest
            </ul>
        </div>
                ...
                <form action="{{ route('posts') }}" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <textarea name="status" class="form-control @error('status') border border-danger @enderror border-0 shadow-none"
                                id="status" rows="3" placeholder="What's on your mind?" style="resize: none;"></textarea>
                            @error('status')
